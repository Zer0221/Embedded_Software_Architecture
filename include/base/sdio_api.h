...
typedef struct {
    ...
    uint8_t manufacturing_date[2];        /**< 制造日期 */
} sdio_card_info_t;
...
typedef struct {
    ...
    bool enable_4bit;                     /**< 启用4位模式 */
    bool enable_high_speed;               /**< 启用高速模式 */
 ...
 */
api_status_t sdio_init(const sdio_config_t *config, sdio_callback_t callback, void *arg, sdio_handle_t *handle);
 ...
 * @return api_status_t 操作状态
 */
api_status_t sdio_deinit(sdio_handle_t handle);
 ...
 * @return api_status_t 操作状态
 */
api_status_t sdio_detect_card(sdio_handle_t handle, bool *card_inserted);
 ...
 * @return api_status_t 操作状态
 */
api_status_t sdio_get_card_info(sdio_handle_t handle, sdio_card_info_t *card_info);
 ...
 * @return api_status_t 操作状态
 */
api_status_t sdio_read_blocks(sdio_handle_t handle, uint32_t block_addr, void *data, uint32_t block_count);
 ...
 * @return api_status_t 操作状态
 */
api_status_t sdio_write_blocks(sdio_handle_t handle, uint32_t block_addr, const void *data, uint32_t block_count);
 ...
 * @return api_status_t 操作状态
 */
api_status_t sdio_erase_blocks(sdio_handle_t handle, uint32_t start_block, uint32_t end_block);
 ...
 * @return api_status_t 操作状态
 */
api_status_t sdio_get_status(sdio_handle_t handle, sdio_status_t *status);
 ...
 * @return api_status_t 操作状态
 */
api_status_t sdio_set_bus_width(sdio_handle_t handle, sdio_bus_width_t bus_width);
 ...
 * @return api_status_t 操作状态
 */
api_status_t sdio_set_freq_mode(sdio_handle_t handle, sdio_freq_mode_t freq_mode);
 ...
 * @return api_status_t 操作状态
 */
api_status_t sdio_enable_write_protect(sdio_handle_t handle, bool enable);
 ...
 * @return api_status_t 操作状态
 */
api_status_t sdio_get_write_protect(sdio_handle_t handle, bool *is_protected);
 ...
 * @return api_status_t 操作状态
 */
api_status_t sdio_get_block_size(sdio_handle_t handle, uint32_t *block_size);
 ...
 * @return api_status_t 操作状态
 */
api_status_t sdio_set_block_size(sdio_handle_t handle, uint32_t block_size);
 ...
 * @return api_status_t 操作状态
 */
api_status_t sdio_execute_command(sdio_handle_t handle, uint8_t cmd, uint32_t arg, uint32_t *resp, uint32_t resp_len);
